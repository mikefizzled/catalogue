...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2024 at 04:25 AM
...
(41, 'Pied Wagtail', '', 1, 1, 24, 32, 1, 'pied-wagtail-thumb.jpg'),
...
(20, 25, 'carrion-crow-1.jpg', 'Unknown', 'Unknown', 'A carrion crow sat on a roof ridge.', '2024-07-01', 1),
...
(68, 40, 'great-black-backed-gull-1.jpg', NULL, NULL, 'A Great Black-Backed Gull observing the shoreline for food.', '2024-09-11', 8),
...
(7, 'Bridlington Harbour', 'Bridlington', 54.0812, -0.187167, NULL, 'A busy working harbour with sandy banks.'),
(8, 'Barmston Beach', 'Barmston', 54.0184, -0.21441, NULL, 'A sandy beach with a large rocky deposits and rock pools. Coastal erosion is eroding the sand banks used as habitats.'),
...
--
ALTER TABLE `animals`
  MODIFY `animal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `family`
  MODIFY `family_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `genus`
--
ALTER TABLE `genus`
  MODIFY `genus_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
